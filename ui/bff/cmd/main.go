...
func main() {
	...
	flag.StringVar(&cfg.ModelName, "model_name", "granite", "Model name")
	flag.StringVar(&cfg.PredictorHost, "predictor_host", "127.0.0.1", "predictor_host")
	flag.IntVar(&cfg.PredictorHttpPort, "http_port", 90, "PredictorHttpPort")
